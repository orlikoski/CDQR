...
eventlog_dict = {
    ...
    '535':'Logon Failure - The specified account password has expired',
    ...
    '6403':'BranchCache: The hosted cache sent an incorrectly formatted response to the client message to offer it data.',
